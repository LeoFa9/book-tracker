...
Проект состоит из нескольких активити (MainActivity, AddBookActivity, DetailActivity)  
Продуманный дизайн и контент  
Используются уведомления в строке состояния  
Осуществляется подключение к серверу БД для извлечения и записи данных  
Приложение протестировано на разных версиях Android и на устройствах с разными размерами и разрешением экрана
